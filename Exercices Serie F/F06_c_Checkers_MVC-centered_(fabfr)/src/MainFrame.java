...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void drawPanelMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_drawPanelMouseReleased
        int startCol = (startPoint.x - drawPanel.getOffsetLeft()) / drawPanel.getSquareSide();
        int startRow = (startPoint.y - drawPanel.getOffsetTop ()) / drawPanel.getSquareSide();
        int endCol   = (evt.getX()   - drawPanel.getOffsetLeft()) / drawPanel.getSquareSide();
        int endRow   = (evt.getY()   - drawPanel.getOffsetTop())  / drawPanel.getSquareSide();
