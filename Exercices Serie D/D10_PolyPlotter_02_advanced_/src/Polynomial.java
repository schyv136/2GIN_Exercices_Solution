...
public class Polynomial {
    ...
    private double xmax;
    /**
     * activer/désactiver l'antialias     */
    private boolean antialiased = true;

    /**
     * ymin l'ordonnée mathématique minimale à représenter --> calculée automatiquement
     * ymax l'ordonnée mathématique maximale à représenter --> calculée automatiquement
     */
    
    //Fixe les limites mathématiques du graphique
    ...
    public Polynomial derivatedPolynomial() {
        Polynomial deriv = new Polynomial();
        for (int i = 1; i < alCoefficients.size(); i++) {
            deriv.add(alCoefficients.get(i) * i);
        }
        return deriv;
    }
